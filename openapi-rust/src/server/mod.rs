...
) -> std::result::Result<(models::CreateRequest,), ValidationErrors> {
    ...
    A: apis::users::Users<Claims = C> + apis::ApiKeyAuthHeader<Claims = C>,
{
    ...
    let resp = match result {
        Ok(rsp) => match rsp {
            apis::users::CreateUserResponse::Status201_UserCreatedSuccessfully(body) => {
            ...
            apis::users::CreateUserResponse::Status400_BadRequest(body) => {
            ...
            apis::users::CreateUserResponse::Status401_Unauthorized(body) => {
            ...
            apis::users::CreateUserResponse::Status422_UnprocessableEntity(body) => {
    ...
    A: apis::users::Users<Claims = C> + apis::ApiKeyAuthHeader<Claims = C>,
{
    ...
    let resp = match result {
        Ok(rsp) => match rsp {
            ...
            apis::users::DeleteUserResponse::Status400_BadRequest(body) => {
                let mut response = response.status(400);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::DeleteUserResponse::Status401_Unauthorized(body) => {
                let mut response = response.status(401);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::DeleteUserResponse::Status404_UserNotFound(body) => {
            ...
            apis::users::DeleteUserResponse::Status422_UnprocessableEntity(body) => {
                let mut response = response.status(422);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
...
#[tracing::instrument(skip_all)]
fn get_all_users_validation() -> std::result::Result<(), ValidationErrors> {
    Ok(())
}
    ...
    A: apis::users::Users<Claims = C> + apis::ApiKeyAuthHeader<Claims = C>,
{
    ...
    let resp = match result {
        Ok(rsp) => match rsp {
            apis::users::GetAllUsersResponse::Status200_Success(body) => {
            ...
            apis::users::GetAllUsersResponse::Status400_BadRequest(body) => {
                let mut response = response.status(400);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::GetAllUsersResponse::Status401_Unauthorized(body) => {
                let mut response = response.status(401);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::GetAllUsersResponse::Status422_UnprocessableEntity(body) => {
                let mut response = response.status(422);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
    ...
    A: apis::users::Users<Claims = C> + apis::ApiKeyAuthHeader<Claims = C>,
{
    ...
    let resp = match result {
        Ok(rsp) => match rsp {
            apis::users::GetUserByIdResponse::Status200_Success(body) => {
                let mut response = response.status(200);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::GetUserByIdResponse::Status400_BadRequest(body) => {
                let mut response = response.status(400);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::GetUserByIdResponse::Status401_Unauthorized(body) => {
                let mut response = response.status(401);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::GetUserByIdResponse::Status404_UserNotFound(body) => {
                let mut response = response.status(404);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::GetUserByIdResponse::Status422_UnprocessableEntity(body) => {
                let mut response = response.status(422);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
...
) -> std::result::Result<(models::UpdateUserPathParams, models::UpdateRequest), ValidationErrors> {
    path_params.validate()?;
    ...
    A: apis::users::Users<Claims = C> + apis::ApiKeyAuthHeader<Claims = C>,
{
    ...
    let resp = match result {
        Ok(rsp) => match rsp {
            apis::users::UpdateUserResponse::Status200_Success(body) => {
                let mut response = response.status(200);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::UpdateUserResponse::Status400_BadRequest(body) => {
                let mut response = response.status(400);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::UpdateUserResponse::Status401_Unauthorized(body) => {
                let mut response = response.status(401);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::UpdateUserResponse::Status404_UserNotFound(body) => {
                let mut response = response.status(404);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
            ...
            apis::users::UpdateUserResponse::Status422_UnprocessableEntity(body) => {
                let mut response = response.status(422);
                {
                    let mut response_headers = response.headers_mut().unwrap();
                    response_headers.insert(
